...
#  Default: ''
c.NotebookApp.notebook_dir = '/home/layewang/'
...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$XK2KSovDn+wUA6uzsCYWPw$Fv+6Aws/BIF8AnU4v1QhbxLR7r64/K404Dx920MOY2Y'
...
#  Choices: any of ['sha3_384', 'sha3_512', 'sha256', 'blake2b', 'sha1', 'sha384', 'blake2s', 'sha512', 'sha3_256', 'md5', 'sha224', 'sha3_224']
#  Default: 'sha256'
